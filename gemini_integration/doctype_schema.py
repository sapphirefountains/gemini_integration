...
def get_doctype_schema_summary(doctype: str) -> dict:
    ...
    excluded_field_types = [
        ...
        'HTML', 'Image', 'Read Only', 'Table', 'Attach', 'Attach Image',
        'Password', 'Code', 'Geolocation', 'Signature'
    ]
    ...
    for field in meta.fields:
        ...
        if field.fieldtype == 'Link' and field.options:
            field_info['description'] = (f"{field_info['description']} "
                                         f"This links to the {field.options} DocType.").strip()
