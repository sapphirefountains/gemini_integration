...
function setupGeminiChatWidget() {
	...
	chatOverlay.id = "gemini-chat-overlay";
	chatOverlay.innerHTML = `
        <div id="gemini-chat-overlay-header">
            <h5>Gemini Chat</h5>
            <button id="close-gemini-overlay" class="btn btn-default btn-xs">&times;</button>
        </div>
        <div id="gemini-chat-overlay-content"></div>
    `;
	...
	chatBubble.addEventListener("click", toggleChatOverlay);
	document.getElementById("close-gemini-overlay").addEventListener("click", toggleChatOverlay);
}
